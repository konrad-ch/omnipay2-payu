...
use Omnipay\PayU\Messages\OrderCaptureRequest;
use Omnipay\PayU\Messages\OrderDetailsRequest;
...
class Gateway extends AbstractGateway
{
    ...
    public function orderCapture(array $parameters = [])
    {
        $this->setAccessToken($this->getAccessToken()->getAccessToken());
        $request = self::createRequest(OrderCaptureRequest::class, $parameters);
        $response = $request->send();
    ...
    {
        $this->setAccessToken($this->getAccessToken()->getAccessToken());
        $request = self::createRequest(OrderDetailsRequest::class, $parameters);
        $response = $request->send();
